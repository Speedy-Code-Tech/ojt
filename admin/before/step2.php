        ...
        <div class="wrapper">
            ...
            <div id="content">
                <div class="container-fluid text-center">
                    <h3>INTERN FORM STEP 2</h3>
                </div>
                <div class="container-fluid text-start">
                    <h3>Documents (STEP 2)</h3>
                    <a href="<?= $data['step2_docs_link'] ?>" target="_blank" rel="noopener noreferrer">Submitted Documents G-Drive link for Step 2</a>
                </div>
