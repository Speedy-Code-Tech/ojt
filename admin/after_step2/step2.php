        ...
        <div class="wrapper">
            ...
            <div id="content">
                <div class="container-fluid text-center">
                    <h3>INTERN FORM AFTER OJT STEP 1</h3>
                </div>
                <div class="container-fluid text-start">
                    <h3>Documents (STEP 1)</h3>
                    <a href="<?= $data['after_ojt_step1'] ?>" target="_blank" rel="noopener noreferrer">Submitted Documents G-Drive link for Step 2</a>
                </div>
