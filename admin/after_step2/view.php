...
$result2 = $conn->query("SELECT * FROM application_table WHERE after_ojt_status = 'PENDING' AND after_ojt_steps = 3");
?>

<body>
    <!-- Sidebar -->
    <?php
    $_SESSION["page"] = "afterstep2";
    include("../sidebar.php");
    ?>
    <!-- Main Content -->
    <div class="dashboard">
        <h2>2ND STEP PENDING AFTER OJT</h2>
        <hr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container-fluid d-flex gap-2 justify-content-center align-items center">
                                ...
                                <button id="approve" data-id="<?= $row['application_id']; ?>" class="btn btn-success">Approve</button>
                            </div>
                        </td>
                    </tr>
                <?php
