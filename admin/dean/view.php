...
<body>
    ...
    $result = $conn->query("SELECT * FROM user WHERE type='dean'");
    ?>
    <!-- Main Content -->
    <div class="dashboard">
        <h2>DEAN ACCOUNTS</h2>
        <a href="add.php" class="btn btn-success" style="position: absolute; right: 30px; top: 20px;"><i class="fa-solid fa-plus"></i> Add New Dean</a>
        <hr>
