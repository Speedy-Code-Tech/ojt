...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending 
                        ...
                        WHERE application_status = 'PENDING'  AND application_step = 0");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline 
                        FROM application_table 
                        WHERE application_status = 'DECLINED'  AND application_step = 0");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending2 
                        FROM application_table 
                        WHERE application_status = 'PENDING'  AND application_step = 1");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline2 
                        FROM application_table 
                        WHERE application_status = 'DECLINED'  AND application_step = 2");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending3 
                        FROM application_table 
                        WHERE application_status = 'PENDING'  AND application_step = 2");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline3 
                        FROM application_table 
                        WHERE application_status = 'DECLINED'  AND application_step = 3");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending4
                        FROM application_table 
                        WHERE application_status = 'PENDING'  AND application_step = 3");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline4
                        FROM application_table 
                        WHERE application_status = 'DECLINED'  AND application_step = 4");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending5
                        FROM application_table 
                        WHERE application_status = 'PENDING'  AND application_step = 5");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline5
                        FROM application_table 
                        WHERE application_status = 'DECLINED'  AND application_step = 5");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve5 
                        FROM application_table 
                        WHERE  application_step >= 5 AND application_status='ACCEPTED'");
