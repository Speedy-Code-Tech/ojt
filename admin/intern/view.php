...
<body>
    ...
    $result = $conn->query("SELECT * FROM user WHERE type='intern'");
    ?>
    <!-- Main Content -->
    <div class="dashboard">
        <h2>INTERN ACCOUNTS</h2>
        <div class="d-flex gap-3"  style="position: absolute; right: 30px; top: 20px;">
        <a href="add.php" class="btn btn-success"><i class="fa-solid fa-plus"></i> Add New Intern</a>
        <a href="bulk.php" class="btn btn-success"><i class="fa-solid fa-plus"></i> Bulk Add Intern</a>
