...
<body>
    ...
    $rejected = $conn->query("SELECT * FROM application_table WHERE  (application_status='DECLINED' AND pi_dept='$data') OR (after_ojt_status='DECLINED' AND pi_dept='$data')");
    $all = $conn->query("SELECT * FROM application_table WHERE  (application_status != 'DECLINED' AND pi_dept='$data') OR (after_ojt_status != 'DECLINED' AND pi_dept='$data')");
    ...
    <div class="dashboard">
        ...
        <table class="table table-hover table-striped" id="announcement">
            ...
            <tbody>
                ...
                $all = $conn->query("SELECT * FROM application_table WHERE (application_status!='DECLINED' AND pi_dept='$data') OR (after_ojt_status!='DECLINED' AND pi_dept='$data') $program_filter $department_filter");
        ...
        <table class="table table-hover table-striped" id="reject">
            ...
            <tbody>
                ...
                $rejected = $conn->query("SELECT * FROM application_table WHERE (application_status='DECLINED' AND pi_dept='$data') OR (after_ojt_status='DECLINED' AND pi_dept='$data') $program_filter $department_filter");
