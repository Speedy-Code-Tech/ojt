...
if (isset($_GET['id']) && isset($_GET['status'])) {
    ...
    $query = "UPDATE application_table SET application_status = '$status', application_step = 5 WHERE application_id = ?";
    ...
    if ($stmt) {
        ...
        $_SESSION['msg'] = "Congratualation! Please proceed to last Step before Deployment <3!";
        } else {
