...
$adviser = $conn->query("SELECT * FROM user WHERE type='adviser' AND department = '$data'");
$intern = $conn->query("SELECT * FROM user WHERE type='intern' AND department = '$data'");
