...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending 
                        ...
                        WHERE application_status = 'PENDING' AND pi_dept = ? AND application_step = 0");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline 
                        FROM application_table 
                        WHERE application_status = 'DECLINED' AND pi_dept = ? AND application_step = 0");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve 
                        FROM application_table 
                        WHERE pi_dept = ? AND application_step >= 1 ");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending2 
                        FROM application_table 
                        WHERE application_status = 'PENDING' AND pi_dept = ? AND application_step = 1");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline2 
                        FROM application_table 
                        WHERE application_status = 'DECLINED' AND pi_dept = ? AND application_step = 2");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve2 
                        FROM application_table 
                        WHERE pi_dept = ? AND application_step >= 2");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending3 
                        FROM application_table 
                        WHERE application_status = 'PENDING' AND pi_dept = ? AND application_step = 2");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline3 
                        FROM application_table 
                        WHERE application_status = 'DECLINED' AND pi_dept = ? AND application_step = 3");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve3 
                        FROM application_table 
                        WHERE pi_dept = ? AND application_step >= 3");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending4
                        FROM application_table 
                        WHERE application_status = 'PENDING' AND pi_dept = ? AND application_step = 3");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline4
                        FROM application_table 
                        WHERE application_status = 'DECLINED' AND pi_dept = ? AND application_step = 4");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve4 
                        FROM application_table 
                        WHERE pi_dept = ? AND application_step >= 4");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending5
                        FROM application_table 
                        WHERE application_status = 'PENDING' AND pi_dept = ? AND application_step = 5");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline5
                        FROM application_table 
                        WHERE application_status = 'DECLINED' AND pi_dept = ? AND application_step = 5");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve5 
                        FROM application_table 
                        WHERE pi_dept = ? AND application_step >= 5 AND application_status='ACCEPTED'");
$stmt->bind_param('s', $department); // Bind $department as a string
$stmt->execute();
$result = $stmt->get_result();
