...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending 
                        ...
                        WHERE after_ojt_status = 'PENDING'   AND pi_dept = '$department'  AND after_ojt_steps = 2");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline 
                        FROM application_table 
                        WHERE after_ojt_status = 'DECLINED'  AND pi_dept = '$department'  AND after_ojt_steps = 2");
...
$stmt1 = $conn->prepare("SELECT COUNT(*) AS total_approve 
                        FROM application_table 
                        WHERE pi_dept = '$department'  AND  after_ojt_steps > 2 ");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending2 
                        FROM application_table 
                        WHERE after_ojt_status = 'PENDING'  AND pi_dept = '$department'  AND after_ojt_steps = 3");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline2 
                        FROM application_table 
                        WHERE after_ojt_status = 'DECLINED'  AND pi_dept = '$department'  AND after_ojt_steps = 3");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve2 
                        FROM application_table 
                        WHERE  after_ojt_steps >= 4 AND pi_dept = '$department'  ");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_pending3 
                        FROM application_table 
                        WHERE after_ojt_status = 'PENDING'  AND pi_dept = '$department'  AND after_ojt_steps = 4");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_decline3 
                        FROM application_table 
                        WHERE after_ojt_status = 'DECLINED'  AND pi_dept = '$department'  AND after_ojt_steps = 4");
...
$stmt = $conn->prepare("SELECT COUNT(*) AS total_approve3 
                        FROM application_table 
                        WHERE  after_ojt_steps >= 4 AND after_ojt_status='ACCEPTED' AND pi_dept = '$department'");
