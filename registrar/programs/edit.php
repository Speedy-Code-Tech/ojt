...
<head>
    ...
    <title>OJT System - Add Programs</title>
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="container-fluid">
            ...
            <label for="programs" class="form-label">Program Name</label>
            <input type="text" name="programs" id="programs" placeholder="BS in *****" value="<?= htmlspecialchars($programs);?>" class="form-control">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Insert query
        $sql = "UPDATE programs SET `programs`='$programs' WHERE id=$id";

        if (mysqli_query($conn, $sql)) {
            $_SESSION['status'] = 'success';
            $_SESSION['message'] = 'Programs updated successfully!';
        } else {
